...
.DESCRIPTION
    ...
    configuration. For unattended deploys use Deploy-Microsoft365Apps.ps1. ODT is downloaded from Microsoft's CDN.
...
if ($usePreset) {
    ...
    try {
        ...
        Write-Host ' Preset configurations are missing. Ensure configs\ is next to Microsoft365AppsDeployment.psm1' -ForegroundColor Red
...
Write-Host ' Language (ODT ID):' -ForegroundColor White

Write-Host '  [1] en-us  [2] en-gb  [3] fr-fr  [4] de-de  [5] nl-nl  [6] es-es  [7] pt-br'

$langChoice = Read-Choice -Prompt 'Select' -Valid @('1', '2', '3', '4', '5', '6', '7') -Default '1'

$langMap = @{ '1' = 'en-us'; '2' = 'en-gb'; '3' = 'fr-fr'; '4' = 'de-de'; '5' = 'nl-nl'; '6' = 'es-es'; '7' = 'pt-br' }

$languageId = $langMap[$langChoice]
